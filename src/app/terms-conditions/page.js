      ...
      <div className="max-w-screen mx-auto">
        ...
        <div className="space-y-6 text-left text-sm sm:text-base leading-relaxed">
          ...
          <p>
            ...
            and purchasing something from us, you engage in our "Service" and
          ...
          <p>
            <strong>b) You, the User, the Client:</strong> You, as the user of
          ...
          <p>
            <strong>c) Parties:</strong> Collectively, the parties to these
          ...
          <p>
            ...
            following: Financial Services mainly Stock Market Research and
            Recommendations on Securities. We reserve the right to refuse
            service or refuse to sell the products on the Website at our sole
          ...
          <p className="mb-4">
            ...
            scrape; (k) for any obscene or immoral purpose; or (l) to interfere
            with or circumvent the security features of the Service or any
            related website, other websites, or the Internet; (m) to personally
          ...
          <p className="mb-4">
            ...
            related website for violating any of the prohibited uses. We reserve
            the full authority to review all content posted by Users on the
            Website. You acknowledge that the Website is not responsible or
            liable and does not control the content of any information that may
            be posted to the Website by You or other User of the Website and you
            are solely responsible for the same. You agree that You shall not
            upload, post, or transmit any content that you do not have a right
            to make available (such as, the intellectual property of another
            party).
          </p>
          ...
          <p className="mb-4">
            ...
            that could constitute a criminal offence, give rise to civil
          ...
          <p>
            ...
            property or these Terms of Service. You may not use our products for
          ...
          <p>
            ...
            may also receive information from external applications You use to
            access Our Website, or We may receive information through various
            web technologies, such as cookies, log files, clear gifs, web
            beacons or others.
          </p>
          <p>
            b) How We Use Information: We use the information gathered from You
            to ensure Your continued good experience on Our website, including
            through email communication. We may also track certain of the
          ...
          <p>
            ...
            Your web browser. Please be aware that the Owner will still receive
            information about You that You have provided, such as Your email
            address. If You choose to terminate Your account, the Owner may
            store some information about You for future reference for the
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <li>
              if there were no goods supplied, 30 days after the day on which we
              are informed about your decision to cancel this contract.
            </li>
            <li>Please note that services sold are non-refundable.</li>
          </ul>
          <p className="mt-2">
            ...
            agreed otherwise; in any event, you will incur fees (which are
            nonrefundable in nature like payment gateway charges) as a result of
            the reimbursement.
          </p>
          ...
          <p className="mt-2">
            a) To the extent any part or sub-part of these Terms of Service is
            held ineffective or invalid by any court of law, You agree that the
            prior, effective version of these Terms of Service shall be
            considered enforceable and valid to the fullest extent.
          </p>
          <p className="mt-2">
            b) You agree to routinely monitor these Terms of Service and refer
            to the Effective Date posted at the top of these Terms of Service to
            note modifications or variations. You further agree to clear Your
            cache when doing so to avoid accessing a prior version of these
            Terms of Service. You agree that Your continued use of the Website
            after any modifications to these Terms of Service is a manifestation
            of Your continued assent to these Terms of Service.
          </p>
          <p className="mt-2">
            c) In the event that You fail to monitor any modifications to or
            variations of these Terms of Service, You agree that such failure
            shall be considered an affirmative waiver of Your right to review
          ...
          <p>
            ...
            mandatory in nature. You hereby waive the right to any objection of
            venue, including assertion of the doctrine of forum non-conveniens
            or similar doctrine.
          </p>
          ...
          <p>
            ...
            or the rights granted hereunder, be assigned, sold, leased or
          ...
          <p>
            <strong>f) HEADINGS FOR CONVENIENCE ONLY:</strong> Headings of parts
            and sub-parts under these Terms of Service are for convenience and
          ...
          <p>
            <strong>j) REFUND POLICY:</strong>
            <br />
            <strong>No Refunds.</strong> All sales are final, and the Company
            does not offer any money-back guarantees. You recognize and agree
            that you shall not be entitled to a refund for any purchase under
            any circumstances.
          </p>
        </div>
      </div>
